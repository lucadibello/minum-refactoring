...
% One of the As examined in \autoref{sec:project_health_analysis}, the library presents many design issues that could have been avoided by following best practices. Additionally, the library entrypoint \texttt{WebFramework} class presents a design issue, as it represents a monolithic class that is responsible for handling all incoming requests. This class should be refactored to adhere to the Single Responsibility Principle (SRP) \cite{wiki:srp} thus improving the overall design of the library.
